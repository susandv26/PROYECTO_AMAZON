...
if (!user) {
  ...
  window.location.href = '/FRONTEND/login/login.html'; // Redirige al login
}
...
dropdownUser.innerHTML = `
      <span class="lin1">Hola, ${user.name}</span><br>
      <span class="lin2"><strong>Cuenta & listas</strong></span>
  `;
}
